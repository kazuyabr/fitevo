...
class GeminiAiService implements AiService {
  ...
  Future<RoutinePlan> generateStarterRoutine({
    ...
    final restLine = restDayNames.isEmpty
        ? 'Rest weekdays (is_rest:true, exercises array MUST be empty): NONE — the user trains every day.'
        : 'Rest weekdays (is_rest:true, exercises array MUST be empty): ${restDayNames.join(', ')}.';
    // User's set/rep preferences (or "AI decides" when null). When set,
    // every exercise on every training day MUST use these exact numbers.
    ...
    final repsLine = (preferredRepsLow != null && preferredRepsHigh != null)
        ...
        : '  5. Pick a rep range that matches the goal (12–15 for endurance, 8–12 for muscle, 5–8 for strength).';
    final prompt =
        ...
        '  1. Return EXACTLY 7 day entries, one per weekday (1=Monday, 2=Tuesday, 3=Wednesday, 4=Thursday, 5=Friday, 6=Saturday, 7=Sunday). No weekday may be missing.\n'
        '  2. Training weekdays (is_rest:false, exercises array non-empty): ${trainingDayNames.join(', ')}.\n'
        '  3. $restLine\n'
        '$setsLine\n'
        '$repsLine\n'
