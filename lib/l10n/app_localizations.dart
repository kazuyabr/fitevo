...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'VivaSaudavel backup — restore by importing this JSON on a fresh install.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Generated by VivaSaudavel · {timestamp}'**
